...
var LogoDown = function (CONTEXT)
	{
		...
		this.getX = function (){return positionInCanvas.X;}
		this.getY = function (){return positionInCanvas.Y;}
		...
		this.moveUp = function (){
		  if(img.complete)
		  	{
			 this.drawImg();
		     positionInCanvas.Y-=moveYpx;
//			 if(positionInCanvas.Y > repeatWhen)positionInCanvas.Y=initpx;
		    }///end if
		  };
